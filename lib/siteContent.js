...
export const defaultContent = {
  ...
  // Upload history for the résumé PDF. Written by the admin Résumé panel
  // (components/admin/ResumeManager.js); newest first. Never hand-edited.
  resumeVersions: [],
  // variant id → résumé entry, served at /resume?v=<id>. Written by the admin
  // Résumé panel; "default" lives in `resume` above, not here.
  resumeByVariant: {},
  patents: facts.patents, // Publications section — patents & papers
  // Per-route SEO overrides, keyed by pathname. Anything omitted falls back to
  // the component defaults in components/Seo.js.
...
export const sectionMeta = [
  ...
  { key: "seo", label: "SEO / social preview per page" },
